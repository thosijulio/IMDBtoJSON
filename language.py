...
movie_title = "Citizen Kane"  # Replace this with the movie title you're interested in

# TMDb API URL for searching movies
search_url = f"https://api.themoviedb.org/3/search/movie?api_key={api_key}&query={movie_title}&language=pt-BR"
...
if response.status_code == 200:
    ...
    if data['results']:
        ...
        if details_response.status_code == 200:
            ...
            title_pt_br = movie_details['title']
            print(movie_details)
